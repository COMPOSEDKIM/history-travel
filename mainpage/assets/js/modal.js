...
const tokyoimgTop = [
  "사진/도쿄/히비야 공원.jpg",
  "사진/도쿄/이중교.jpg",
  "사진/도쿄/도쿄 가든 테라스 기오이초.jpg",
];
const tokyoimgBottom = [
  "사진/도쿄/nakano prison.jpg",
  "사진/도쿄/Tokutomi Roka Memorial Museum.jpg",
  "사진/도쿄/Karasuyama Shrine.jpg",
];

const tokyotitleTop = ["히비야 공원", "이중교", "도쿄 가든 테라스 기오이초"];
const tokyotitleBottom = [
  "nakano prison",
...
const osakaimgTop = [
  "사진/오사카/오사카시 중앙공회당3.jpg",
  "사진/오사카/호코쿠 신사.jpg",
  "사진/오사카/front torii.jpg",
];
const osakaimgBottom = [
  "사진/오사카/오사카 사회운동현창탑3.jpg",
  "사진/오사카/통국사.jpg",
  "사진/오사카/보당사.jpg",
];
...
const sanfimgTop = [
  "사진/샌프/골든게이트 교.jpg",
  "사진/샌프/상항한인연합장로교회.jpg",
  "사진/샌프/사이프레스 론 퓨너럴 홈 & 기념공원.jpg",
];
const sanfimgBottom = [
  "사진/샌프/페어몬트 샌프란시스코.jpg",
  "사진/샌프/St Mary's Square.jpg",
  "사진/샌프/Ferry Building.jpg",
];
const sanftitleTop = [
  "골든게이트 교",
  "상항한인연합장로교회",
...
const sanftitleBottom = [
  "페어몬트 샌프란시스코",
  "St Mary's Square",
  "Ferry Building",
];
const sanfTop = [
  "금문교가 위치한 샌프란시스코는 20세기 초반 한인 이민자들과 독립운동가들이 많이 활동하던 도시였습니다. 독립운동가들은 이곳에서 자금을 모으고, 일본 제국주의에 맞서기 위한 전략을 세웠습니다. 따라서 금문교는 이 도시의 중요한 랜드마크로서, 한인 독립운동의 역사적 배경을 이해하는 데 도움이 됩니다.",
...
const seoulimgBottom = [
  "사진/서울/3.1 독립운동기념탑.jpg",
  "사진/서울/만해기념관.jpg",
  "사진/서울/덕수궁 대한문.jpg",
];
const seoulTop = [
  "백범 김구 기념관은 대한민국 임시정부 주석을 지낸 김구 선생의 생애와 업적을 기념하기 위해 설립된 기념관입니다. 서울 용산구에 위치해 있으며, 김구 선생의 유품과 독립운동 관련 자료들이 전시되어 있습니다.",
...
const seoulBottom = [
  "3.1운동을 기념하기 위해 세워진 기념탑으로, 서울 종로구 탑골공원에 위치해 있습니다. 1919년 3.1운동 당시의 정신과 의미를 기념하며, 독립운동가들의 희생을 기리고 있습니다.",
...
const usuriskimgTop = [
  "사진/우수리스크/Monument to victims of the April events.jpg",
  "사진/우수리스크/신한촌 기념비.jpg",
];
const usuriskimgBottom = [
  "사진/우수리스크/최재형선생 거주지.jpg",
  "사진/우수리스크/우수리스크 역.jpg",
];
const usurisktitleTop = [
  "Monument to victims of the April events",
  "신한촌 기념비",
];
...
const shanghaititleTop = [
  "huangpu park",
  "Shanghai Christian Church Moore Memorial Church",
  "Jing'an Park",
];
const shanghaititleBottom = [
  "Shanghai Library",
  "Song Qingling Mausoleum",
  "Xiwai International School",
];
const shanghaiimgTop = [
  "사진/상하이/huangpu park.jpg",
  "사진/상하이/Shanghai Christian Church Moore Memorial Church.jpg",
  "사진/상하이/Jing'an Park.jpg",
];
const shanghaiimgBottom = [
  "사진/상하이/Shanghai Library.jpg",
  "사진/상하이/Song Qingling Mausoleum.jpeg",
  "사진/상하이/Xiwai International School.jpg",
];

const shanghaiTop = [
  "1922년 의열단의 오성륜과 김익상이 일본 육군대장 다나카를 저격했던 황포탄 의거가 있던 장소입니다.",
...
const shanghaiBottom = [
  "Shanghai Library는 한국 독립운동과 관련된 다양한 자료들이 보관되어 있습니다. 연구자들과 일반인들이 독립운동 역사에 대해 연구할 수 있는 중요한 자원입니다.",
...
const btn = document.getElementById("tokyo");
...
const vlogbtn = document.getElementById("vlogButton");
vlogbtn.addEventListener("click", goplan);
