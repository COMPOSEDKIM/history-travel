...
function initMap() {
  ...
  const directionsRenderer = new google.maps.DirectionsRenderer({
    ...
    const map = new google.maps.Map(document.getElementById("map"), {
      center: {lat: 42.876329, lng: 74.60134900000001},
      zoom: 13,
    ...
    function changenum(num) {
     ...
     function qweqwe6() {
    hm = {lat: 42.876329, lng: 74.60134900000001} //Monument to victims of the April events. To the left of the house, 
    addMaker2();
    addplan();
    labelnum = labelnum + 1;
    //selectBox.value = 'D2';
    hm = {lat: 43.7915492, lng: 131.945137} //최재형선생 거주지, 
     addMaker2();
    addplan();

    labelnum = labelnum + 1;
    hm = {lat: 43.80158, lng: 131.98083} //우수리스크 역, 
     addMaker2();
    addplan();

    labelnum = labelnum + 1;
    hm = {lat: 43.1349662, lng: 131.8953842} //신한촌 기념비, 
    addMaker2();
    //addplan();
