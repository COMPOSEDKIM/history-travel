...
function initMap() {
  ...
  const directionsRenderer = new google.maps.DirectionsRenderer({
    ...
    const map = new google.maps.Map(document.getElementById("map"), {
      center: {lat: 31.241431, lng: 121.49082},
      zoom: 13,
    ...
    function changenum(num) {
     ...
     function qweqwe4() {
    hm = {lat: 31.241431, lng: 121.49082} //huangpu park,  
    addMaker2();
    addplan();
    labelnum = labelnum + 1;
    //selectBox.value = 'D2';
    hm =  {lat: 31.233275, lng: 121.475868} //Shanghai Christian Church Moore Memorial Church,
     addMaker2();
    addplan();

    labelnum = labelnum + 1;
    hm =  {lat: 31.22154879999999, lng: 121.4460741} //Jing'an Park,
     addMaker2();
    addplan();

    labelnum = labelnum + 1;

    hm =  {lat: 31.207374, lng: 121.444766}// Shanghai Library, 
    addMaker2();
   addplan();

   labelnum = labelnum + 1;

   hm =  {lat: 31.195023, lng: 121.410689} //Song Qingling Mausoleum, 
   addMaker2();
  addplan();

  labelnum = labelnum + 1;
    hm = {lat: 31.044013, lng: 121.233905} // Xiwai International School 
    addMaker2();
    //addplan();
