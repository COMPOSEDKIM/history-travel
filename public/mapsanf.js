...
function initMap() {
  ...
  const directionsRenderer = new google.maps.DirectionsRenderer({
    ...
    function changenum(num) {
     ...
     function qweqwe2() {
    hm = {lat: 37.8199109, lng: -122.4785598} //골든게이트 교
    addMaker2();
    addplan();
    labelnum = labelnum + 1;
    //selectBox.value = 'D2';
    hm = {lat: 37.7615248, lng: -122.4173683} //상항한인연합장로교회,
     addMaker2();
    addplan();

    labelnum = labelnum + 1;
    hm = {lat: 37.67257149999999, lng: -122.4560124} //사이프레스 론 퓨너럴 홈 & 기념공원
     addMaker2();
    addplan();

    labelnum = labelnum + 1;

    hm = {lat: 37.7923897, lng: -122.4104443} //페어몬트 샌프란시스코
    addMaker2();
    addplan();
    labelnum = labelnum + 1;

    hm = {lat: 37.79204180000001, lng: -122.4052396} //St Mary's Square
    addMaker2();
    addplan();
    labelnum = labelnum + 1;
    hm = {lat: 37.7954425, lng: -122.3936136} //Ferry Building
    addMaker2();
    //addplan();
