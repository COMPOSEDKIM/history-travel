...
function initMap() {
  ...
  const directionsRenderer = new google.maps.DirectionsRenderer({
    ...
    function changenum(num) {
     ...
     function qweqwe5() {
    hm = {lat: 35.67361149999999, lng: 139.7558769} //   히비야 공원, 
    addMaker2();
    addplan();
    labelnum = labelnum + 1;
    //selectBox.value = 'D2';
    hm =    {lat: 35.6802297, lng: 139.7535852} //  이중교,
     addMaker2();
    addplan();

    labelnum = labelnum + 1;
    hm = {lat: 35.6799926, lng: 139.7379363} // 도쿄 가든 테라스 기오이초
     addMaker2();
    addplan();

    labelnum = labelnum + 1;

    hm ={lat: 35.71449949999999, lng: 139.6620149} //  nakano prison, 
    addMaker2();
    addplan();
    labelnum = labelnum + 1;

    hm ={lat: 35.6623119, lng: 139.6111442}// Tokutomi Roka Memorial Museum,
    addMaker2();
    addplan();
    labelnum = labelnum + 1;

    hm =  {lat: 35.67484219999999, lng: 139.6054834} // Karasuyama park, 
    addMaker2();
    //addplan();
