...
function initMap() {
  ...
  const directionsRenderer = new google.maps.DirectionsRenderer({
    ...
    function changenum(num) {
     ...
     function qweqwe() {
    hm = {lat: 34.6935485, lng: 135.5039123} //오사카시 중앙공회당, 
    addMaker2();
    addplan();
    labelnum = labelnum + 1;
    //selectBox.value = 'D2';
    hm = {lat: 34.6842971, lng: 135.5263235} //호코쿠 신사, 
     addMaker2();
    addplan();

    labelnum = labelnum + 1;

    hm = {lat: 34.68451390000001, lng: 135.5270993} //front torii, 
    addMaker2();
    addplan();
    labelnum = labelnum + 1;

    hm = {lat: 34.6882851, lng: 135.533715} //오사카 사회운동현창탑, 
    addMaker2();
    addplan();
    labelnum = labelnum + 1;

    hm = {lat: 34.650661, lng: 135.51196} //통국사, 
     addMaker2();
    addplan();

    labelnum = labelnum + 1;
    hm = {lat: 34.662595, lng: 135.7011399} //보당사 
    addMaker2();
    //addplan();
