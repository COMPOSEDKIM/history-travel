let geocoder;
// const ejsmm = require('../views/post.ejs');
...
function initMap() {
  ...
  // const testValue = post.test1;
  // const placenameValue = post.placename1; 
  const a = document.getElementById("1");
  console.log(a.value)

  //let testGET = JSON.parse(testValue);
  ...
  //let placenameGET = JSON.parse(placenameValue);
